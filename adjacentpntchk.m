% Function to check the adjacent cells for a value that is 1 less than the value at the current cell & return the position of that cell.
% This is useful to retrace the path from the end point to the start.

function [path_cell_position] = adjacentpntchk(cell,mat)	
	cell_x = cell(1);
	cell_y = cell(2);
